...
import { ExternalLink, BarChart3, Copy, Check, Tag } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid gap-4">
          {urls.length === 0 ? (
            ...
            urls.map((url) => (
              <div key={url._id} className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end border-t md:border-0 pt-3 md:pt-0">
